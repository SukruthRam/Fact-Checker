...
public class Team
{
    ...
    private boolean checkForTeam(String s)
    {
            ...
            try
            {
                if (rev.get(0) != null)
                {
                    ...
                    if (h != null)
                    {
                        ...
                        {
                            result = result.replace(" LA ", "Los Angeles ");
                        }
                        ...
                        if(g.contains("#REDIRECT"))
                        {
                            g = g.replaceAll("[#REDIRECT]", "");
                            int a = g.indexOf("[[");
                            int b = g.indexOf("]]");
                            ...
                            url = "https://en.wikipedia.org/w/api.php?action=query&prop=revisions&rvprop=content&format=json&titles=" + u + "&rvsection=0";
                            //System.out.println(url);
    ...
    private String ifKeyword(String[] out, String place)
    {
        ...
        {
            if(out[i].contains(place) && !out[i].contains("draft_team"))
            {
                rtr = rtr + out[i];
